!function(t, e) {
    ...
    function S() {
        return S = Object.assign ? Object.assign.bind() : function(t) {
            for (var e = 1; e < arguments.length; e++) {
                var i = arguments[e];
                for (var s in i)
                    ({}).hasOwnProperty.call(i, s) && (t[s] = i[s])
            }
            return t
        }
        ,
    ...
    var C = function(t) {
        function e(e) {
            ...
            return (i = t.call(this) || this).config = u,
    ...
    var A = function() {
      ...
      , Y = function() {
        function t(t, e, i) {
            ...
            this.config.legend && (this.legend = new A(u({
                map: this._map,
                series: this
            }, this.config.legend))),
    ...
    var T = {
        ...
        _setupContainerTouchEvents: function() {
            ...
            g.on(o.container, "touchstart", h),
            g.on(o.container, "touchmove", h)
        },
        ...
        _setScale: function(t, e, i, s, a) {
            ...
            this._emit(v.onViewportChange, [this.scale, this.transX, this.transY]))
        },
        setFocus: function(t) {
            var e = this;
            void 0 === t && (t = {});
      ...
      , V = function() {
        ...
        return e._init = function() {
            ...
            t.series && (this.container.appendChild(this.legendHorizontal = l("div", "jvm-series-container jvm-series-h")),
        ...
        e.setSelectedRegions = function(t) {
            ...
            this._setSelected("regions", this._normalizeRegions(t))
        }
        ,
        ...
        e._emit = function(t, e) {
            for (var i in v)
                v[i] === t && "function" == typeof this.params[i] && this.params[i].apply(this, e)
        }
        ,
