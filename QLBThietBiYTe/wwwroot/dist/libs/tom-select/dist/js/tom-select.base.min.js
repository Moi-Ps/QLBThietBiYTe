...
!(function (t, e) {
  ...
  const f = new RegExp(Object.keys(h).join("|") + "|[̀-ͯ·ʾʼ]", "gu"),
    ...
    v = (t) => Array.from(t).reduce((t, e) => t + y(e), ""),
    y = (t) => (
      (t = m(t)
        .toLowerCase()
        .replace(f, (t) => h[t] || "")),
      ...
      i(
        c(t).map((t) =>
          ((t, e = 1) => {
            let i = 0;
            return (
              (t = t.map((t) => (u[t] && (i += t.length), u[t] || t))),
              i >= e ? s(t) : ""
            );
          })(t, e)
        )
  ...
  const _ = (t) => {
      void 0 === u && (u = b(d)), (t = v(t));
      let e = "",
        i = [new A()];
      for (let s = 0; s < t.length; s++) {
        let n = t.substring(s).match(p);
        const o = t.substring(s, s + 1),
          r = n ? n[0] : null;
        let l = [],
          a = new Set();
        for (const t of i) {
          ...
          if (!e || 1 == e.length || e.end <= s)
            if (r) {
              const e = r.length;
              t.add({ start: s, end: s + e, length: e, substr: r }), a.add("1");
            } else
              t.add({ start: s, end: s + 1, length: 1, substr: o }), a.add("2");
          else if (r) {
            let i = t.clone(s, e);
            const n = r.length;
    ...
    E = (t, e) =>
      "number" == typeof t && "number" == typeof e
        ? t > e
          ...
          ? -1
          : 0
        : (t = v(t + "").toLowerCase()) > (e = v(e + "").toLowerCase())
        ? 1
        : e > t
        ? -1
        : 0;
      ...
      return (
        ...
        n.forEach((t) => {
          ...
          o && (i = t.match(o)) && ((n = i[1]), (t = i[2])),
            t.length > 0 &&
              ((l = this.settings.diacritics ? _(t) || null : r(t)),
              l && e && (l = "\\b" + l)),
            s.push({
              string: t,
    ...
    _getScoreFunction(t) {
      ...
      const l =
        1 === o
          ? function (t, e) {
              const i = s[0].field;
              return x(r(e, i), t, n[i] || 1);
            }
          : function (t, e) {
              var i = 0;
              if (t.field) {
                const s = r(e, t.field);
                !t.regex && s ? (i += 1 / o) : (i += x(s, t, 1));
              } else
                k(n, (s, n) => {
                  i += x(r(e, n), t, s);
                });
      ...
      return i.length
        ? function (t, e) {
            ...
            for (let o of i) {
              if (
                ((n = o.field),
                (s = ("desc" === o.direction ? -1 : 1) * E(r(n, t), r(n, e))))
              )
                return s;
            }
            return 0;
        ...
        3 === t.nodeType
          ? ((t) => {
              ...
              if (i && t.data.length > 0) {
                ...
                var o = n.cloneNode(!0);
                return s.appendChild(o), st(n, s), 1;
              }
              return 0;
            })(t)
          : (((t) => {
      ...
      "select" === d
            ...
            var f = (t) => {
              ...
              m = (t, e) => {
                ...
                if (null != s && (s || i.allowEmptyOption)) {
                  ...
                  t.selected && p.items.push(s);
                }
              };
            (p.maxItems = t.hasAttribute("multiple") ? null : 1),
              B(t.children, (t) => {
                var i, s, n;
                "optgroup" === (e = t.tagName.toLowerCase())
                  ? (((n = f((i = t)))[a] =
        ...
        : (() => {
            ...
            if (e)
              ...
              B(e, (t) => {
                const e = {};
                (e[n] = t), (e[o] = t), p.options.push(e);
              }),
                (p.items = e);
            }
          })(),
      Object.assign({}, rt, p, e)
    );
  }
  var at = 0;
  class ct extends (function (t) {
    ...
    constructor(t, e) {
      ...
      var p;
      if (
        (U(r, n.wrapperClass, d, u),
        U(l, n.controlClass),
        z(r, l),
        U(a, n.dropdownClass, u),
        n.copyClassesToDropdown && U(a, d),
        U(c, n.dropdownContentClass),
        z(a, c),
        ...
        B(
          ...
          (t) => {
            s.getAttribute(t) && it(p, { [t]: s.getAttribute(t) });
          }
        ),
          (p.tabIndex = -1),
          l.appendChild(p),
    ...
    setup() {
      ...
      const p = N(c, t.inputId + "-ts-control"),
        h =
          "label[for='" +
        ...
        f = t.focus.bind(t);
      if (g) {
        R(g, "click", f), it(g, { for: p });
        const e = N(g, t.inputId + "-ts-label");
        it(c, { "aria-labelledby": e }), it(n, { "aria-labelledby": e });
      }
      ...
      (null === e.maxItems || e.maxItems > 1) &&
        t.is_select_tag &&
        it(a, { multiple: "multiple" }),
        e.placeholder && it(i, { placeholder: e.placeholder }),
        !e.splitOn &&
          e.delimiter &&
          (e.splitOn = new RegExp("\\s*" + r(e.delimiter) + "+\\s*")),
        e.load && e.loadThrottle && (e.load = j(e.load, e.loadThrottle)),
        R(s, "mousemove", () => {
          t.ignoreHover = !1;
        }),
        R(
        ...
        R(s, "click", (e) => {
          ...
          i && (t.onOptionSelect(e, i), D(e, !0));
        }),
        R(l, "click", (e) => {
          var s = Z(e.target, "[data-ts-item]", l);
          s && t.onItemSelect(e, s)
            ? D(e, !0)
            : "" == i.value && (t.onClick(), D(e, !0));
        }),
        R(c, "keydown", (e) => t.onKeyDown(e)),
        R(i, "keypress", (e) => t.onKeyPress(e)),
        R(i, "input", (e) => t.onInput(e)),
        R(c, "blur", (e) => t.onBlur(e)),
        R(c, "focus", (e) => t.onFocus(e)),
        R(i, "paste", (e) => t.onPaste(e));
      const m = (e) => {
          const n = e.composedPath()[0];
          if (!o.contains(n) && !s.contains(n))
            return t.isFocused && t.blur(), void t.inputState();
          n == i && t.isOpen ? e.stopPropagation() : D(e, !0);
        },
        v = () => {
          t.isOpen && t.positionDropdown();
        };
      R(document, "mousedown", m),
        R(window, "scroll", v, d),
        R(window, "resize", v, d),
        (this._destroy = () => {
        ...
        t.inputState(),
        (t.isSetup = !0),
        a.disabled ? t.disable() : a.readOnly ? t.setReadOnly(!0) : t.enable(),
        t.on("change", this.onChange),
        U(a, "tomselected", "ts-hidden-accessible"),
    ...
    sync(t = !0) {
      const e = this,
        i = t ? lt(e.input, { delimiter: e.settings.delimiter }) : e.settings;
    ...
    onKeyDown(t) {
      ...
      if (((e.ignoreHover = !0), e.isLocked)) 9 !== t.keyCode && D(t);
        ...
        switch (t.keyCode) {
          case 65:
            if (H(ot, t) && "" == e.control_input.value)
              return D(t), void e.selectAll();
            break;
          case 27:
            return e.isOpen && (D(t, !0), e.close()), void e.clearActiveItems();
          case 40:
          ...
          case 13:
            return void (e.canSelect(e.activeOption)
              ? (e.onOptionSelect(t, e.activeOption), D(t))
          ...
          case 9:
            return void (
              ...
              (e.canSelect(e.activeOption) &&
                (e.onOptionSelect(t, e.activeOption), D(t)),
              e.settings.create && e.createItem() && D(t))
            );
          case 8:
          case 46:
            return void e.deleteSelection(t);
        }
        e.isInputHidden && !H(ot, t) && D(t);
      }
    }
    onInput(t) {
    ...
    onFocus(t) {
      ...
      e.ignoreFocus ||
        ...
        e.activeItems.length ||
          (e.inputState(), e.refreshOptions(!!e.settings.openOnFocus)),
        e.refreshState());
    }
    onBlur(t) {
    ...
    loadCallback(t, e) {
      ...
      (i.loading = Math.max(i.loading - 1, 0)),
        ...
        i.loading || W(i.wrapper, i.settings.loadingClass),
        i.trigger("load", t, e);
    }
    preload() {
    ...
    setTextboxValue(t = "") {
      ...
      e.value !== t && ((e.value = t), G(e, "update"), (this.lastValue = t));
    }
    getValue() {
    ...
    setActiveItem(t, e) {
      ...
      if ("single" !== a.settings.mode) {
        ...
        if (
          ...
          ("click" === i && H(ot, e)) || ("keydown" === i && H("shiftKey", e))
    ...
    clearActiveOption() {
      this.activeOption &&
        ...
        it(this.activeOption, { "aria-selected": null })),
        (this.activeOption = null),
        it(this.focus_node, { "aria-activedescendant": null });
    }
    selectAll() {
      const t = this;
    ...
    inputState() {
      ...
      t.control.contains(t.control_input) &&
        (it(t.control_input, { placeholder: t.settings.placeholder }),
        ...
        (!t.isFocused && t.settings.hidePlaceholder && t.items.length > 0)
          ...
          : (t.settings.hidePlaceholder &&
              t.items.length > 0 &&
              it(t.control_input, { placeholder: "" }),
            (t.isInputHidden = !1)),
    ...
    refreshOptions(t = !0) {
      ...
      const b = (t, e) => {
        ...
        return (
          (i = p.length), p.push({ fragment: s, order: e, optgroup: t }), [i, s]
        );
      };
      for (e = 0; e < n; e++) {
        let t = m.items[e];
        ...
        for (
          ...
          i > 0 &&
            ((d = d.cloneNode(!0)),
            it(d, { id: l.$id + "-clone-" + i, "aria-selected": null }),
      ...
      var w;
      h.settings.lockOptgroupOrder && p.sort((t, e) => t.order - e.order),
      ...
      if (
        (h.loading
          ...
          : I("not_loading"),
        (a = h.canCreate(g)) && (d = I("option_create")),
        ...
        if (m.items.length > 0) {
          if (
            ...
            let t = 0;
            d && !h.settings.addPrecedence && (t = 1), (v = h.selectable()[t]);
          }
        } else d && (v = d);
        t && !h.isOpen && (h.open(), h.scrollToOption(v, "auto")),
          h.setActiveOption(v);
    ...
    updateOption(t, e) {
      ...
      if (
        ...
        if (i.dropdown_content.contains(a)) {
          ...
          st(a, t), i.activeOption === a && i.setActiveOption(t);
        }
        a.remove();
      }
      c &&
        ...
        (s = i._render("item", e)),
        c.classList.contains("active") && U(s, "active"),
        st(c, s)),
        (i.lastQuery = null);
    }
    removeOption(t, e) {
    ...
    getItem(t) {
      ...
      var e = P(t);
      return null !== e
        ? this.control.querySelector(`[data-value="${M(e)}"]`)
        : null;
    }
    addItems(t, e) {
      var i = this,
    ...
    addItem(t, e) {
      q(this, e ? [] : ["change", "dropdown_close"], () => {
        var i, s;
        const n = this,
          o = n.settings.mode,
          r = P(t);
    ...
    refreshState() {
      ...
      s.toggle("focus", t.isFocused),
        ...
        s.toggle("readonly", t.isReadOnly),
    ...
    updateOriginalInput(t = {}) {
      ...
      if (e.is_select_tag) {
        ...
        function l(t, i, s) {
          return (
            t || (t = K('<option value="' + V(i) + '">' + V(s) + "</option>")),
            t != n && e.input.append(t),
            o.push(t),
            (t != n || r > 0) && (t.selected = !0),
            t
          );
        }
                ...
                if (
                  ...
                  l(
                    e.input.querySelector(
                      `option[value="${M(t)}"]:not(:checked)`
                    ),
                    t,
                    s
                  );
                } else i.$option = l(i.$option, t, s);
              });
    ...
    open() {
      ...
      t.isLocked ||
        ...
        ((t.isOpen = !0),
        it(t.focus_node, { "aria-expanded": "true" }),
        t.refreshState(),
        J(t.dropdown, { visibility: "hidden", display: "block" }),
        t.positionDropdown(),
        J(t.dropdown, { visibility: "visible", display: "block" }),
        t.focus(),
    ...
    close(t = !0) {
      ...
      t &&
        (e.setTextboxValue(),
        "single" === e.settings.mode && e.items.length && e.inputState()),
        (e.isOpen = !1),
        it(e.focus_node, { "aria-expanded": "false" }),
        J(e.dropdown, { display: "none" }),
    ...
    deleteSelection(t) {
      ...
      if (r.activeItems.length)
        (n = tt(r.activeItems, e)),
          (s = et(n)),
          e > 0 && s++,
          B(r.activeItems, (t) => l.push(t));
      else if (
      ...
      for (D(t, !0), void 0 !== s && r.setCaret(s); l.length; )
        r.removeItem(l.pop());
    ...
    destroy() {
      ...
      t.trigger("destroy"),
        ...
        W(t.input, "tomselected", "ts-hidden-accessible"),
        t._destroy(),
      ...
      if (
        ...
        "option" === t || "option_create" === t
          ? e[n.settings.disabledField]
            ? it(s, { "aria-disabled": "true" })
            : it(s, { "data-selectable": "" })
          : "optgroup" === t &&
            ((i = e.group[n.settings.optgroupValueField]),
            it(s, { "data-group": i }),
            e.group[n.settings.disabledField] &&
              it(s, { "data-disabled": "" })),
        "option" === t || "item" === t)
      ) {
        const i = $(e[n.settings.valueField]);
        it(s, { "data-value": i }),
          "item" === t
            ? (U(s, n.settings.itemClass), it(s, { "data-ts-item": "" }))
            : (U(s, n.settings.optionClass),
              it(s, { role: "option", id: e.$id }),
              (e.$div = s),
              (n.options[i] = e));
      }
      return s;
